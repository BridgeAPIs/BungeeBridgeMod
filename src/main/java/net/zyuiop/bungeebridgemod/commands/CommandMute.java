...
import net.zyuiop.bungeebridgemod.moderation.JsonModMessage;
import net.zyuiop.bungeebridgemod.moderation.ModerationTools;
...
public class CommandMute extends ModCommand {
    ...
    public CommandMute(BungeeBridgeMod bridge) {
